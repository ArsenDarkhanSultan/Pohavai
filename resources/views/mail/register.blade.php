                        ...
                        <div class="column" style="text-align: left;color: #787778;font-size: 16px;line-height: 24px;font-family: Ubuntu,sans-serif;">
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 30px;line-height: 38px;text-align: center;"><strong>{{$user->name}}, спасибо за регистрацию!</strong>
                                    </h1>
                                    <p style="Margin-top: 20px;Margin-bottom: 0;">&nbsp;<br />Мы будем рады видеть вас в списке наших пользователей и очень ценим что вы выбрали нас.</p>
                                    <p style="Margin-top: 20px;Margin-bottom: 20px;">Мы будем стараться предоставлять вам самые лучшие рекомендации на основе ваших предпочтений, по этой причине настоятельно просим вас не забывать добавлять понравившиеся заведения в избранные, и наш ИИ сможет подбирать для вас самый качественные предложения!
                                    А для того чтобы завершить вашу регистрацию, вы можете нажать кнопку ниже:</p>
                                </div>
                            </div>
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <p style="Margin-top: 0;Margin-bottom: 20px;"><em>Все ваши данные конфиденциальны и доступ к ним будет только у системы!</em></p>
                                </div>
                            </div>
